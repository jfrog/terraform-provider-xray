...
provider "xray" {
  //  supply ARTIFACTORY_URL (or JFROG_URL) and ARTIFACTORY_ACCESS_TOKEN (or XRAY_ACCESS_TOKEN/JFROG_ACCESS_TOKEN) as env vars
}
...
//      type = "all-repos"
//      filters = [
//        { type = "package-type", value = "Docker" },
//        { type = "package-type", value = "Debian" },
//      ]
//    }
//  }
//  assigned_policies = [
//    { name = xray_security_policy.security1.name, type = "security" },
//  ]
//
