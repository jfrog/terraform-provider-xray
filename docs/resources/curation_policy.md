...
- `share_with_federation` (Boolean) When true, the policy is shared across federated instances. Only allowed when scope is 'all_repos' or 'pkg_types'. Defaults to false.
